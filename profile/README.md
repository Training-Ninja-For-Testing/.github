...
|-----------|------------|---------|-----------|
| [qax-automation-mobile-robot-framework](https://github.com/Training-Ninja-For-Testing/qax-automation-mobile-robot-framework) | Robot Framework | ![status](https://img.shields.io/badge/status-in%20progress-yellow?style=flat-square) | ![Python](https://img.shields.io/badge/Python-blue?logo=python&style=flat-square) |
